...
const hotDishesFood = [
  ...
  },
  {
    ...
    price: 2190,
    description: 'Японская лапша рамен с нежной курицей, овощами и ароматным бульоном. Сытное и вкусное блюдо.',
    ingredients: ['Лапша', 'Курица', 'Овощи', 'Бульон', 'Яйцо'],
    img: ''
  },
  {
    name: 'Рамен с морепродуктами',
    price: 2590,
    description: 'Рамен с ассорти морепродуктов в наваристом бульоне. Морская свежесть в японском стиле.',
    ingredients: ['Лапша', 'Морепродукты', 'Овощи', 'Бульон', 'Яйцо'],
    img: ''
  },
  {
    name: 'Лапша по домашнему с курицей',
    price: 1200,
    description: 'Домашняя лапша с сочной курицей и овощами в ароматном бульоне. Согревающее блюдо для души и тела.',
  ...
  {
    name: 'Вок лапша с овощами',
    price: 1890,
    description: 'Обжаренная лапша с овощами в азиатском стиле. Вегетарианское удовольствие с аутентичным вкусом.',
    ingredients: ['Лапша', 'Овощи', 'Соус'],
    img: ''
  },
  {
    name: 'Вок лапша с курицей',
    price: 1990,
    description: 'Обжаренная лапша с курицей и овощами в азиатском стиле. Сытное блюдо с ярким вкусом.',
    ingredients: ['Лапша', 'Курица', 'Овощи', 'Соус'],
    img: ''
  },
  {
    name: 'Бефстроганов',
...
const saladsSandwiches = [
  ...
  },
  {
    name: 'Бургер с фри',
    price: 2390,
    description: 'Классический бургер с сочной котлетой, сыром, свежими овощами и хрустящим картофелем фри. Американская классика в полном наборе.',
    ingredients: ['Булочка', 'Котлета', 'Сыр', 'Овощи', 'Соус', 'Картофель фри'],
    img: ''
  },
  {
    name: 'Наггетсы',
