...
const breakfastBakery = [
  ...
  },
  {
    ...
    price: 1400,
    description: 'Традиционный национальный завтрак с кашей, лепёшкой, сыром и яйцом. Домашний вкус и теплота.',
  ...
  },
  {
    ...
    price: 900,
    description: 'Тонкие и нежные блины, подаются со свежей сметаной. Классика русской кухни.',
  ...
  },
  {
    name: 'Блины с джемом',
    price: 900,
    description: 'Тонкие блины с ароматным фруктовым джемом. Сладкое удовольствие для сладкоежек.',
  ...
  },
  {
    ...
    price: 1000,
    description: 'Блины с нежным шоколадным соусом. Идеальное сочетание для любителей шоколада.',
  ...
  },
  {
    name: 'Панини',
    price: 1200,
    description: 'Итальянский горячий сэндвич панини с сыром и ветчиной. Аутентичный вкус Италии.',
...
function Section({ title, children }) {
  return (
    <div className="section">
      <h2 style={{ textAlign: 'left', fontWeight: 600, fontSize: 32, letterSpacing: 1, color: '#E63900', marginLeft: '16px' }}>{title}</h2>
      {children}
    </div>
  );
}
